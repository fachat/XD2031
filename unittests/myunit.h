...
static inline void mu_assert_err_str_eq(const char *name, const char *is,
					const char *shouldbe)
{
...
static inline void mu_assert_info_str_eq(const char *name, const char *is,
					 const char *shouldbe)
{
	if (mu_strcmp(is, shouldbe)) {
...
static inline void mu_assert_debug_str_eq(const char *name, const char *is,
					  const char *shouldbe)
{
	if (mu_strcmp(is, shouldbe)) {
