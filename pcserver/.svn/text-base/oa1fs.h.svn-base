...
#define   FS_OPEN_RD     1         /* Datei zum Lesen îffnen               */
#define   FS_OPEN_WR     2         /* Datei zum Schreiben îffnen           */
#define   FS_OPEN_RW     3         /* Datei zum Lesen und Schreiben îffnen */
#define   FS_OPEN_OW     4         /* Datei zum Åberschreiben îffnen       */
#define   FS_OPEN_AP     5         /* Datei zum AnhÑngen îffnen            */
#define   FS_OPEN_DR     6         /* Verzeichnis zum Lesen îffnen         */
#define   FS_RENAME      7         /* Datei Umbennen                       */
#define   FS_DELETE      8         /* Datei lîschen                        */
#define   FS_FORMAT      9         /* Diskette formatieren                 */
#define   FS_CHKDSK      10        /* Diskette auf Konsistenz testen       */
#define   FS_CLOSE       11        /* Datei lîschen (nur bei OPEN_RW)      */
#define   FS_RMDIR       12        /* Unterverzeichnis lîschen             */
#define   FS_MKDIR       13        /* Unterverzeichnis erstellen           */
#define   FS_CHDIR       14        /* ----                                 */
#define   FS_ASSIGN      15        /* ----                                 */

/* Struktur, die bei OPEN gesendet werden muû                              */

#define   FS_OPEN_DRV    0         /* Laufwerk = FM_OPEN_DRV               */
#define   FS_OPEN_STR    1         /* Stream, Åber den Daten laufen sollen */
